...
label_dir = '/home/kai/Desktop/Cityscapes/meta_extra/label_extra_imgs'
txtSave_dir = '/home/kai/Desktop/Cityscapes/meta/label_extra_img_56_2/'
...
def regionSearch(subImage, priority):
    cell_Label = np.zeros(2, dtype=int)
...
for image in imagesList:
    ...
    for num_cell, cell in enumerate(newCellList):
        # label_image = cv2.rectangle(label_image, (cell[0][0], cell[0][1]), (cell[1][0], cell[1][1]), (0, 255, 0), 2)
