...
colorsList = [(128, 64,128), (244, 35,232), (70, 70, 70), (102,102,156), (190,153,153), (153,153,153), (250,170, 30), (220,220,  0), (107,142, 35), (152,251,152)
              , ( 70,130,180), (220, 20, 60), (255,  0,  0), (  0,  0,142),(  0,  0, 70),(  0, 60,100) , (  0, 80,100) , (  0,  0,230), (119, 11, 32) ]
...
if not os.path.exists(cityscapes_meta_path + "/label_imgsForTrain"):
    os.makedirs(cityscapes_meta_path + "/label_imgsForTrain")
if not os.path.exists(cityscapes_meta_path + "/label_imgsForTest"):
    os.makedirs(cityscapes_meta_path + "/label_imgsForTest")

# if not os.path.exists(cityscapes_meta_path + "/imgsForTrain"):
#     os.makedirs(cityscapes_meta_path + "/imgsForTrain")
# if not os.path.exists(cityscapes_meta_path + "/imgsForTest"):
#     os.makedirs(cityscapes_meta_path + "/imgsForTest")
...
for train_dir in train_dirs:
    ...
    for file_name in file_names:
        ...
        # cv2.imwrite(cityscapes_meta_path + "/imgsForTrain/" + img_id + ".png", img)
        # img_id = file_name.split("_leftImg8bit.png")[0]
        #
        ...
        cv2.imwrite(cityscapes_meta_path + "/label_imgsForTrain/" + img_id + ".png", label_img)
        train_label_img_paths.append(cityscapes_meta_path + "/label_imgsForTrain/" + img_id + ".png")
...
for val_dir in val_dirs:
    ...
    for file_name in file_names:
        ...
        # img = cv2.imread(img_path, -1)  # (shape: (1024, 2048))
        img_id = file_name.split("_leftImg8bit.png")[0]
        # cv2.imwrite(cityscapes_meta_path + "/imgsForTest/" +  img_id + ".png", img)
        ...
        cv2.imwrite(cityscapes_meta_path + "/label_imgsForTest/" + img_id + ".png", label_img)
