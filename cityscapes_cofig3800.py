...
txtSave_dir = '/home/kai/Desktop/Cityscapes/meta_extra/label_txtForTrain_extra_all3800/'
...
def regionSearch(subImage, priority):
    ...
    cell_Label = np.zeros(19, dtype=int)
    flag = np.zeros(19, dtype=int)
    subColor = []
...
for image in imagesList:
    ...
    # cv2.waitKey(0)
    AllCellLabel = []
    for num_cell, cell in enumerate(cellList):
        ...
        if num_cell < 24:
            cellLabel = regionSearch(subimage, priority1)
        else:
            cellLabel = regionSearch(subimage, priority2)
