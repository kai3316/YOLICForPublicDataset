...
# newCellList = [[[0, 512], [128, 640]], [[128, 512], [256, 640]], [[256, 512], [384, 640]], [[384, 512], [512, 640]],
#                [[512, 512], [640, 640]], [[640, 512], [768, 640]], [[768, 512], [896, 640]], [[896, 512], [1024, 640]],
#                [[1024, 512], [1152, 640]], [[1152, 512], [1280, 640]], [[1280, 512], [1408, 640]],
#                [[1408, 512], [1536, 640]], [[1536, 512], [1664, 640]], [[1664, 512], [1792, 640]],  [[1792, 512], [1920, 640]],
#                [[1920, 512], [2048, 640]],
#                [[0, 640], [128, 768]], [[128, 640], [256, 768]], [[256, 640], [384, 768]], [[384, 640], [512, 768]], [[512, 640], [640, 768]],
...
#                [[1664, 640], [1792, 768]], [[1792, 640], [1920, 768]], [[1920, 640], [2048, 768]],
#                [[0, 768], [128, 896]], [[128, 768], [256, 896]], [[256, 768], [384, 896]], [[384, 768], [512, 896]],
#                [[512, 768], [640, 896]], [[640, 768], [768, 896]], [[768, 768], [896, 896]], [[896, 768], [1024, 896]],
#                [[1024, 768], [1152, 896]], [[1152, 768], [1280, 896]], [[1280, 768], [1408, 896]],
#                [[1408, 768], [1536, 896]], [[1536, 768], [1664, 896]], [[1664, 768], [1792, 896]],
...
#                [[1408, 896], [1536, 1024]], [[1536, 896], [1664, 1024]], [[1664, 896], [1792, 1024]],
#                [[1792, 896], [1920, 1024]], [[1920, 896], [2048, 1024]]]  # w,h
# new function return a new list of cells from h=0,w=0 to 1024,2048 and window size of 32,64
...
def regionSearch(subImage, priority):
    cell_Label = np.zeros(5, dtype=int)
    flag = np.zeros(6, dtype=int)
    subColor = []
    for y in range(subImage.shape[0]):
        for x in range(subImage.shape[1]):
            temp = subImage[y][x]
            # if not ( temp == 0 or temp == 1 or temp == 2 or temp == 3 or temp == 4 or temp == 5 or temp == 6 or
            # temp == 9 or temp == 10 or temp == 14 or temp == 15 or temp == 16 or temp == 18 or temp == 29 or temp
            # == 30):
    ...
    if len(counterResult) != 0:
        for item in counterResult:
            ...
            if item != 19:
                ...
                if item == 13 or item == 14 or item == 15 or item == 16 or item == 17 or item == 18:
                    cell_Label[4] = 1
...
for image in imagesList:
    imgPath = os.path.join(label_dir, image)
    imgName = image.split('.')[0]
    print(imgName)
    label_image = cv2.imread(imgPath, -1)
    label_map = np.zeros((5, 1024//windowSize, 2048//windowSize), dtype=np.uint8)
    ...
    for num_cell, cell in enumerate(newCellList):
        ...
        # if num_cell < 182:
        #     continue
        # label_image = cv2.rectangle(label_image, (cell[0][1],cell[0][0]), ( cell[1][1],cell[1][0]), (0, 255, 0), 2)
        # plt.imshow(label_image)
        # plt.show()
        # exit(0)
        subImage = label_image[cell[0][0]:cell[1][0], cell[0][1]:cell[1][1]]
        # plt.imshow(subImage)
        # plt.show()
        cellLabel = regionSearch(subImage, priority)
        # print(num_cell // 32, num_cell % 32)
